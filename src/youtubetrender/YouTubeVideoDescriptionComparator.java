 ...
 * to order the objects of user-defined class by the length of video's description.
 */
public class YouTubeVideoDescriptionComparator implements Comparator<YouTubeVideo> {
    /**
     * This method is to compare two object by the length of video's description.
     *
